<template>
  ...
  <el-card style="margin: 20px 0">
    <div v-if="scene">
      <el-button type="primary" size="default" icon="Plus" :disabled="!categoryStore.category3Id" @click="addAttr">
        添加属性
      </el-button>
      <el-table :data="attrArr" style="width: 100%;margin:10px 0" :border="true">
        <el-table-column prop="number" label="序号" width="80" type="index" align="center" />
        ...
        <el-table-column label="操作" width="120">
          ...
          <template #="{ row, $index }">
            ...
            <el-popconfirm title="确定要删除该属性吗?" @confirm='confirmDelete(row)'>
              <template #reference>
    ...
    <div v-else>
      ...
      <el-button type="primary" size="default" icon="Plus" @click="addAttrHandler"
        :disabled="attrParams.attrName.length == 0">添加属性值</el-button>
      ...
      <el-table border style="margin:10px 0" :data="attrParams.attrValueList">
        ...
        <el-table-column label="属性值名称">
          <!-- row:当前属性值对象 -->
          <template #="{ row, $index }">
            <el-input ref="inputRef" v-if="row.flag" placeholder="请你输入属性值名称" v-model="row.valueName"
        ...
        <el-table-column label="操作">
          <template #="{ row, $index }">
            <el-button icon="Delete" type="primary" size="small" @click="deleteAttrValue($index)"></el-button>
          </template>
        </el-table-column>
      </el-table>
...
import { reqAttr, reqAddorUpdateAttr,reqDeleteAttr } from '../../../api/product/attr/index.ts';
import type { AttrResponseData, AttrList, Attr, AttrValue } from '../../../api/product/attr/type.ts';
