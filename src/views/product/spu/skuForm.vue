<template>
  <el-form label-width="100px">
    ...
    <el-form-item label="平台属性">
      <el-form :inline="true">
        <el-form-item v-for="item in attrArr" :key="item.id" :label="item.attrName">
          <el-select v-model="item.attrIdAndValueId" placeholder="请选择" size="small" style="width: 240px">
    ...
    <el-form-item label="销售属性">
      <el-form :inline="true">
        <el-form-item :label="item.saleAttrName" v-for="item in saleArr" :key="item.id">
          <el-select v-model="item.saleIdAndValueId" placeholder="请选择" size="small" style="width: 240px">
    ...
    <el-form-item label="图片名称">
      <el-table border :data="imgArr" ref="imgTable" @select = selectCheckbox :selectable="false">
...
import { reqGetTradeMarkImageList, reqGetSpuSaleAttrList, reqAddSku } from '../../../api/product/spu';
import { AttrResponseData, AttrList } from '../../../api/product/attr/type';
import { Record, SkuInfo, SpuHasImageListResponseData, SpuImage, SpuImageList, SpuSaleAttr, SpuSaleAttrListResponseData } from '../../../api/product/spu/type';
...
//初始化Sku数据
const initSkuData = (category1Id: string | number, category2Id: string | number, category3Id: string | number, row: Record) => {
...
//获取平台数据
const getAttr = async (category1Id: string | number, category2Id: string | number, category3Id: string | number) => {
