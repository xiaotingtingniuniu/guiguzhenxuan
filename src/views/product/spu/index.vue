<template>
  <div>
    ...
    <el-card style="margin: 10px 0px">
      ...
      <div v-show="scene == 0">
        <el-button type="primary" size="default" icon="Plus" :disabled="!categoryStore.category3Id" @click="addSpu">
          添加SPU
        </el-button>
        <!-- 展示已有SPU数据 -->
        <el-table style="margin: 10px 0px" :border="true" :data="spuData">
          ...
          <el-table-column label="操作">
            <template #="{ row, $index }">
              ...
              <el-button type="info" icon="View" size="small" title="查看SKU列表" @click="findSku(row)"></el-button>
...
const addSku = (row: Record) => {
  ...
  //切换为场景2
  scene.value = 2;
  skuForm.value.initSkuData(categoryStore.category1Id, categoryStore.category2Id, categoryStore.category3Id, row);
}
